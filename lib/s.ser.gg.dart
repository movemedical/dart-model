...
import 'package:movemedical_model/home/home.dart' as _54;
import 'package:movemedical_model/schedule/mod.dart' as _55;
import 'package:movemedical_model/schedule/list.dart' as _56;
import 'package:movemedical_api/model/action/caseEvent/list_case_events_api_request.dart'
    as _57;
import 'package:movemedical_api/model/sql/enums/body_side.dart' as _58;
import 'package:movemedical_api/model/sql/enums/case_event_status.dart' as _59;
import 'package:movemedical_api/model/sql/enums/gender.dart' as _60;
import 'package:movemedical_api/model/pagination_params.dart' as _61;
import 'package:movemedical_api/model/order_by_params.dart' as _62;
import 'package:movemedical_api/model/action/caseEvent/list_case_events_api_order_by.dart'
    as _63;
import 'package:movemedical_api/model/order_by_direction.dart' as _64;
...
import 'package:movemedical_api/model/action/caseEvent/list_case_events_api_case_event.dart'
    as _66;
import 'package:movemedical_model/schedule/list_filter.dart' as _67;
import 'package:movemedical_model/schedule/detail.dart' as _68;
...
import 'package:movemedical_api/model/action/caseEvent/get_case_event_detail_api_case_event.dart'
    as _71;
import 'package:movemedical_api/model/case_type.dart' as _72;
import 'package:movemedical_api/model/biz_unit.dart' as _73;
import 'package:movemedical_api/model/org_unit.dart' as _74;
import 'package:movemedical_api/model/removeOrRefactor/hospital.dart' as _75;
import 'package:movemedical_api/model/physician.dart' as _76;
import 'package:movemedical_api/model/address.dart' as _77;
import 'package:movemedical_api/model/patient.dart' as _78;
...
import 'package:movemedical_api/model/sql/enums/weight_measurement_type.dart'
    as _80;
import 'package:movemedical_api/model/hcr_team.dart' as _81;
import 'package:movemedical_api/model/hcr_team_type.dart' as _82;
import 'package:movemedical_api/model/procedure.dart' as _83;
import 'package:movemedical_api/model/sub_procedure.dart' as _84;
import 'package:movemedical_api/model/action/caseEvent/get_case_event_detail_api_loan.dart'
    as _85;
import 'package:movemedical_api/model/sql/enums/loan_status.dart' as _86;
import 'package:movemedical_api/model/sql/enums/order_status.dart' as _87;
import 'package:movemedical_api/model/insurance.dart' as _88;
import 'package:movemedical_api/model/order_header_lite.dart' as _89;
import 'package:movemedical_api/model/customer_address.dart' as _90;
import 'package:movemedical_api/model/action/caseEvent/get_case_event_detail_api_event.dart'
    as _91;
import 'package:movemedical_api/model/sql/enums/event_type.dart' as _92;
import 'package:movemedical_api/model/sql/enums/event_status.dart' as _93;
import 'package:movemedical_api/model/sql/enums/event_state.dart' as _94;
...
import 'package:movemedical_api/model/action/caseEvent/get_case_event_detail_api_case_doc.dart'
    as _96;
import 'package:movemedical_model/messages/mod.dart' as _97;
import 'package:movemedical_model/messages/list.dart' as _98;
import 'package:movemedical_api/model/action/messaging/conversations/list_conversations_api_request.dart'
    as _99;
import 'package:movemedical_api/model/sql/enums/attributable_type.dart' as _100;
...
import 'package:movemedical_api/model/action/messaging/conversations/list_conversations_api_conversation.dart'
    as _102;
import 'package:movemedical_api/model/attributable_object.dart' as _103;
import 'package:movemedical_model/messages/list_filter.dart' as _104;
import 'package:movemedical_model/messages/detail.dart' as _105;
...
SerializersBuilder $serializers() => (Serializers().toBuilder()
  ...
  ..addBuilderFactory(FullType(BuiltList, [FullType(_58.BodySide)]),
      () => ListBuilder<_58.BodySide>())
  ..addBuilderFactory(FullType(BuiltList, [FullType(_59.CaseEventStatus)]),
      () => ListBuilder<_59.CaseEventStatus>())
  ..addBuilderFactory(
      FullType(BuiltList, [FullType(_66.ListCaseEventsApiCaseEvent)]),
      () => ListBuilder<_66.ListCaseEventsApiCaseEvent>())
  ..addBuilderFactory(FullType(BuiltList, [FullType(_89.OrderHeaderLite)]),
      () => ListBuilder<_89.OrderHeaderLite>())
  ..addBuilderFactory(
      FullType(BuiltList, [FullType(_96.GetCaseEventDetailApiCaseDoc)]),
      () => ListBuilder<_96.GetCaseEventDetailApiCaseDoc>())
  ..addBuilderFactory(FullType(BuiltList, [FullType(_103.AttributableObject)]),
      () => ListBuilder<_103.AttributableObject>())
  ..addBuilderFactory(
      FullType(BuiltList, [FullType(_102.ListConversationsApiConversation)]),
      () => ListBuilder<_102.ListConversationsApiConversation>())
  ..addBuilderFactory(
  ...
  ..addBuilderFactory(
      FullType(_1.ApiCommand, [FullType(_57.ListCaseEventsApiRequest)]),
      () => _1.ApiCommandBuilder<_57.ListCaseEventsApiRequest>())
  ..addBuilderFactory(
      FullType(_1.ApiCommand, [FullType(_69.GetCaseEventDetailApiRequest)]),
      () => _1.ApiCommandBuilder<_69.GetCaseEventDetailApiRequest>())
  ..addBuilderFactory(
      FullType(_1.ApiCommand, [FullType(_99.ListConversationsApiRequest)]),
      () => _1.ApiCommandBuilder<_99.ListConversationsApiRequest>())
  ..addBuilderFactory(
  ...
  ..addBuilderFactory(
      FullType(_1.ApiResult, [FullType(_65.ListCaseEventsApiResponse)]),
      () => _1.ApiResultBuilder<_65.ListCaseEventsApiResponse>())
  ..addBuilderFactory(
      FullType(_1.ApiResult, [FullType(_70.GetCaseEventDetailApiResponse)]),
      () => _1.ApiResultBuilder<_70.GetCaseEventDetailApiResponse>())
  ..addBuilderFactory(
      FullType(_1.ApiResult, [FullType(_101.ListConversationsApiResponse)]),
      () => _1.ApiResultBuilder<_101.ListConversationsApiResponse>())
  ..addBuilderFactory(
  ...
  ..addBuilderFactory(
      ...
      () => _2.CommandBuilder<_1.ApiCommand<_57.ListCaseEventsApiRequest>>())
  ..addBuilderFactory(
      FullType(_2.Command, [
        FullType(_1.ApiCommand, [FullType(_69.GetCaseEventDetailApiRequest)])
      ]),
      () =>
          _2.CommandBuilder<_1.ApiCommand<_69.GetCaseEventDetailApiRequest>>())
  ..addBuilderFactory(
      FullType(_2.Command, [
        FullType(_1.ApiCommand, [FullType(_99.ListConversationsApiRequest)])
      ]),
      () => _2.CommandBuilder<_1.ApiCommand<_99.ListConversationsApiRequest>>())
  ..addBuilderFactory(
      FullType(_2.Command, [
        FullType(_47.RouteCommand, [FullType(_104.ConversationListFilterState)])
      ]),
      () => _2.CommandBuilder<
          _47.RouteCommand<_104.ConversationListFilterState>>())
  ..addBuilderFactory(
      FullType(_2.Command, [
        FullType(_1.ApiCommand, [FullType(_106.GetConversationApiRequest)])
      ]),
  ...
  ..addBuilderFactory(
      ...
      () => _2.CommandResultBuilder<
          _1.ApiResult<_65.ListCaseEventsApiResponse>>())
  ..addBuilderFactory(
      FullType(_2.CommandResult, [
        FullType(_1.ApiResult, [FullType(_70.GetCaseEventDetailApiResponse)])
      ]),
      () => _2.CommandResultBuilder<
          _1.ApiResult<_70.GetCaseEventDetailApiResponse>>())
  ..addBuilderFactory(
      FullType(_2.CommandResult, [
        FullType(_1.ApiResult, [FullType(_101.ListConversationsApiResponse)])
      ]),
      () => _2.CommandResultBuilder<
          _1.ApiResult<_101.ListConversationsApiResponse>>())
  ..addBuilderFactory(
      FullType(_2.CommandResult, [
        FullType(_47.RouteResult, [FullType(_99.ListConversationsApiRequest)])
      ]),
      () => _2.CommandResultBuilder<
          _47.RouteResult<_99.ListConversationsApiRequest>>())
  ..addBuilderFactory(
      FullType(_2.CommandResult, [
        FullType(_1.ApiResult, [FullType(_107.GetConversationApiResponse)])
      ]),
  ...
  ..addBuilderFactory(
      ...
      () => _2.CommandStateBuilder<_1.ApiCommand<_57.ListCaseEventsApiRequest>,
          _1.ApiResult<_65.ListCaseEventsApiResponse>>())
  ..addBuilderFactory(
      FullType(_2.CommandState, [
        FullType(_1.ApiCommand, [FullType(_69.GetCaseEventDetailApiRequest)]),
      ...
      () => _2.CommandStateBuilder<
          _1.ApiCommand<_69.GetCaseEventDetailApiRequest>,
          _1.ApiResult<_70.GetCaseEventDetailApiResponse>>())
  ..addBuilderFactory(
      FullType(_2.CommandState, [
        FullType(_1.ApiCommand, [FullType(_99.ListConversationsApiRequest)]),
      ...
      () => _2.CommandStateBuilder<
          _1.ApiCommand<_99.ListConversationsApiRequest>,
          _1.ApiResult<_101.ListConversationsApiResponse>>())
  ..addBuilderFactory(
      FullType(_2.CommandState, [
        FullType(
            _47.RouteCommand, [FullType(_104.ConversationListFilterState)]),
        FullType(_47.RouteResult, [FullType(_99.ListConversationsApiRequest)])
      ]),
      () => _2.CommandStateBuilder<
          _47.RouteCommand<_104.ConversationListFilterState>,
  ...
  ..addBuilderFactory(
      FullType(_47.RouteCommand, [FullType(_104.ConversationListFilterState)]),
      () => _47.RouteCommandBuilder<_104.ConversationListFilterState>())
  ..addBuilderFactory(
      FullType(_47.RouteResult, [FullType(_99.ListConversationsApiRequest)]), () => _47.RouteResultBuilder<_99.ListConversationsApiRequest>())
  ...
  ..add(_54.HomeState.serializer)
  ..add(_55.ScheduleState.serializer)
  ..add(_56.CaseEventListState.serializer)
  ..add(_57.ListCaseEventsApiRequest.serializer)
  ..add(_58.BodySide.serializer)
  ..add(_59.CaseEventStatus.serializer)
  ..add(_60.Gender.serializer)
  ..add(_61.PaginationParams.serializer)
  ..add(_62.OrderByParams.serializer)
  ..addBuilderFactory(FullType(_62.OrderByParams, [FullType(_63.ListCaseEventsApiOrderBy)]), () => _62.OrderByParamsBuilder<_63.ListCaseEventsApiOrderBy>())
  ..add(_63.ListCaseEventsApiOrderBy.serializer)
  ..add(_64.OrderByDirection.serializer)
  ..add(_65.ListCaseEventsApiResponse.serializer)
  ..add(_66.ListCaseEventsApiCaseEvent.serializer)
  ..add(_67.CaseEventListFilterState.serializer)
  ..add(_68.CaseEventDetailState.serializer)
  ..add(_69.GetCaseEventDetailApiRequest.serializer)
  ..add(_70.GetCaseEventDetailApiResponse.serializer)
  ..add(_71.GetCaseEventDetailApiCaseEvent.serializer)
  ..add(_72.CaseType.serializer)
  ..add(_73.BizUnit.serializer)
  ..add(_74.OrgUnit.serializer)
  ..add(_75.Hospital.serializer)
  ..add(_76.Physician.serializer)
  ..add(_77.Address.serializer)
  ..add(_78.Patient.serializer)
  ..add(_79.LengthMeasurementType.serializer)
  ..add(_80.WeightMeasurementType.serializer)
  ..add(_81.HcrTeam.serializer)
  ..add(_82.HcrTeamType.serializer)
  ..add(_83.Procedure.serializer)
  ..add(_84.SubProcedure.serializer)
  ..add(_85.GetCaseEventDetailApiLoan.serializer)
  ..add(_86.LoanStatus.serializer)
  ..add(_87.OrderStatus.serializer)
  ..add(_88.Insurance.serializer)
  ..add(_89.OrderHeaderLite.serializer)
  ..add(_90.CustomerAddress.serializer)
  ..add(_91.GetCaseEventDetailApiEvent.serializer)
  ..add(_92.EventType.serializer)
  ..add(_93.EventStatus.serializer)
  ..add(_94.EventState.serializer)
  ..add(_95.GetCaseEventDetailApiDisplayRules.serializer)
  ..add(_96.GetCaseEventDetailApiCaseDoc.serializer)
  ..add(_97.MessagesState.serializer)
  ..add(_98.ConversationListState.serializer)
  ..add(_99.ListConversationsApiRequest.serializer)
  ..add(_100.AttributableType.serializer)
  ..add(_101.ListConversationsApiResponse.serializer)
  ..add(_102.ListConversationsApiConversation.serializer)
  ..add(_103.AttributableObject.serializer)
  ..add(_104.ConversationListFilterState.serializer)
