...
class DateUtils {
  ...
  static DateTime endOfToday() {
    ...
    return DateTime(tomorrow.year, tomorrow.month, tomorrow.day).toUtc();
  }

  static DateTime weeksFromNow(int weeks) {
    return DateTime.now().add(Duration(days: weeks * 7)).toUtc();
  }
